...
test('Renders blockquote', () => {
  ...
  assert.equal(
    result,
    '<blockquote class="govuk-inset-text govuk-!-margin-left-0"><p class="govuk-body">Blockquote</p>\n</blockquote>\n'
  )
})
...
test('Renders headings', () => {
  ...
  assert.equal(
    result,
    '<h1 class="govuk-heading-l" id="heading-1">Heading 1</h1><h2 class="govuk-heading-m" id="heading-2">Heading 2</h2><h3 class="govuk-heading-s" id="heading-3">Heading 3</h3><h4 class="govuk-heading-s" id="heading-4">Heading 4</h4>'
  )
})
...
test('Renders heading with id', () => {
  ...
  assert.equal(
    result,
    '<h1 class="govuk-heading-l" id="heading-with-emphasis">Heading with <em>emphasis</em></h1>'
  )
})
...
test('Renders headings, using classes relative to given starting level', () => {
  ...
  assert.equal(
    result,
    '<h1 class="govuk-heading-xl" id="heading-1">Heading 1</h1><h2 class="govuk-heading-l" id="heading-2">Heading 2</h2><h3 class="govuk-heading-m" id="heading-3">Heading 3</h3><h4 class="govuk-heading-s" id="heading-4">Heading 4</h4>'
  )
})
...
test('Renders link with title', () => {
  ...
  assert.equal(
    result,
    '<p class="govuk-body"><a class="govuk-link" href="#" title="Link title">Link</a></p>\n'
  )
})
...
test('Renders ordered list', () => {
  ...
  assert.equal(
    result,
    '<ol class="govuk-list govuk-list--number"><li>Item A</li>\n<li>Item B</li>\n</ol>\n'
  )
})
...
test('Renders unordered list', () => {
  ...
  assert.equal(
    result,
    '<ul class="govuk-list govuk-list--bullet"><li>Item</li>\n<li>Item</li>\n</ul>\n'
  )
})
...
test('Renders task list', () => {
  ...
  assert.equal(
    result,
    '<ul class="govuk-list govuk-list--bullet"><li><span class="x-govuk-checkbox"><input class="x-govuk-checkbox__input" type="checkbox" disabled><span class="x-govuk-checkbox__pseudo"></span></span> Item</li>\n<li><span class="x-govuk-checkbox"><input class="x-govuk-checkbox__input" type="checkbox" checked disabled><span class="x-govuk-checkbox__pseudo"></span></span> Item</li>\n</ul>\n'
  )
})
...
test('Renders code block with preformatted text', () => {
  ...
  assert.equal(
    result,
    '<pre class="x-govuk-code x-govuk-code--block" tabindex="0">Preformatted text</pre>\n'
  )
})
...
test('Renders code block with highlighted syntax', () => {
  ...
  assert.equal(
    result,
    '<pre class="x-govuk-code x-govuk-code--block x-govuk-code__language--js" tabindex="0"><code><span class="x-govuk-code__variable language_">console</span>.<span class="x-govuk-code__title function_">log</span>(<span class="x-govuk-code__string">&#x27;Hello, World!&#x27;</span>)</code></pre>\n'
  )
})
...
test('Renders code block with unknown syntax', () => {
  ...
  assert.equal(
    result,
    '<pre class="x-govuk-code x-govuk-code--block x-govuk-code__language--foo" tabindex="0"><code>^^^Hello, World^^^</code></pre>\n'
  )
})
...
test('Renders code span', () => {
  ...
  assert.equal(
    result,
    '<p class="govuk-body"><code class="x-govuk-code x-govuk-code--inline">code</code></p>\n'
  )
})
